...
define(function(require, exports, module) {
    ...
    exports.index = function ($, tableId,alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/admin/customer-account/pagination',
            columns: [
            {
                'data': 'id',
            ...
            },
            {
                ...
                return `<div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/customer-account/edit/`+data+`"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/customer-account/delete/`+data+`" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
                            <a href="/admin/customer-account/show/`+data+`"> 详情 <i class="fa fa-file-o"></i> </a>
                        </li>
                    </ul>
                </div>`;
                }
            ...
            buttons: [
                { text: '新增<i class="fa fa-fw fa-plus"></i>', action: function () {
                    window.location.href="/admin/customer-account/create"
                }  },
        ...
        $(".table-search").on('click',function(){
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/customer-account/pagination?" + arr).load();
        })

        $(".table-reset").on('click',function(){
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/admin/customer-account/pagination").load();
        })
