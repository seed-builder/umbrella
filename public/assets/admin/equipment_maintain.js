...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/admin/equipment-maintain/pagination',
            columns: [
                {
                    'data': 'id',
                ...
                },
                {
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/equipment-maintain/edit/` + data + `"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/equipment-maintain/delete/` + data + `" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
                            <a href="/admin/equipment-maintain/show/` + data + `"> 详情 <i class="fa fa-file-o"></i> </a>
                        </li>
                    </ul>
                </div>`;
                    }
            ...
            buttons: [
                {
                    ...
                    window.location.href = "/admin/equipment-maintain/create"
                }
                },
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/equipment-maintain/pagination?" + arr).load();
        })

        $(".table-reset").on('click', function () {
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/admin/equipment-maintain/pagination").load();
        })
