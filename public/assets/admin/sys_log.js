...
define(function(require, exports, module) {
    ...
    exports.index = function ($, tableId,alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            },
            {
                ...
                return `<div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/sys-log/edit/`+data+`"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/sys-log/delete/`+data+`" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
                            <a href="/admin/sys-log/show/`+data+`"> 详情 <i class="fa fa-file-o"></i> </a>
                        </li>
                    </ul>
                </div>`;
                }
            ...
            buttons: [
                { text: '新增<i class="fa fa-fw fa-plus"></i>', action: function () {
                    window.location.href="/admin/sys-log/create"
                }  },
        ...
        $(".table-search").on('click',function(){
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/sys-log/pagination?" + arr).load();
        })

        $(".table-reset").on('click',function(){
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/admin/sys-log/pagination").load();
        })
