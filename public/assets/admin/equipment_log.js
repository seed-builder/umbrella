...
define(function(require, exports, module) {
    ...
    exports.index = function ($, tableId,alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/admin/equipment-log/pagination',
            columns: [
            {
                'data': 'id',
            ...
            },
            {
                ...
                return `<div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/equipment-log/edit/`+data+`"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/equipment-log/delete/`+data+`" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
    ...
    columnDefs: [
        {
            ...
            buttons: [
                { text: '新增<i class="fa fa-fw fa-plus"></i>', action: function () {
                    window.location.href="/admin/equipment-log/create"
                }  },
        ...
        $(".table-search").on('click',function(){
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/equipment-log/pagination?" + arr).load();
        })

        $(".table-reset").on('click',function(){
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/admin/equipment-log/pagination").load();
        })
