...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/help/edit/` + data + `"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/help/delete/` + data + `" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
                            <a href="/admin/help/show/` + data + `"> 详情 <i class="fa fa-file-o"></i> </a>
                        </li>
                    </ul>
                </div>`;
                    }
            ...
            buttons: [
                {
                    ...
                    window.location.href = "/admin/help/create"
                }
                },
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/help/pagination?" + arr).load();
        })

        $(".table-reset").on('click', function () {
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/admin/help/pagination").load();
        })
