...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/admin/view-partner-statistics/pagination',
            columns: [
                {
                    'data': 'id',
        ...
        var arr = $.param(data)
        App.ajaxData('/admin/view-partner-statistics/statistics?'+arr,function (resp) {
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/admin/view-partner-statistics/pagination?" + arr).load();
        ...
        $(".table-reset").on('click', function () {
            ...
            table.ajax.url("/admin/view-partner-statistics/pagination").load();
        })
