            ...
            },
            {
                ...
                return `<div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="/admin/customer-payment/edit/`+data+`"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                        </li>
                        <li>
                            <a class="csx-delete" data-url="/admin/customer-payment/delete/`+data+`" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                        </li>
                        <li>
                            <a href="/admin/customer-payment/show/`+data+`"> 详情 <i class="fa fa-file-o"></i> </a>
                        </li>
                    </ul>
                </div>`;
                }
