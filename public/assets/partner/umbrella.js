...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId, App) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/partner/umbrella/pagination',
            columns: [
                // {
                //     'data': 'id',
                ...
                //             '<li>' +
                //             '<a href="/partner/umbrella/edit/` + data + `"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>' +
                //             '</li>' +
                //             '<li>' +
                //             '<a class="csx-delete" data-url="/partner/umbrella/delete/` + data + `" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>' +
                //             '</li>' +
                //             '</ul>' +
                //             '</div>';
                //         //<li><a href="/partner/umbrella/show/` + data + `"> 详情 <i class="fa fa-file-o"></i> </a></li>
                //     }
                // },
                {'data': 'number'},
                {'data': 'sn'},
            ...
            buttons: [
                ...
                //     window.location.href = '/partner/umbrella/down-template';
                // }
                // },
                // {
                ...
                //             // window.location.href = '/partner/umbrella/reset?id='+ids
                //             App.ajaxLink('/partner/umbrella/reset?id='+ids,'#' + alertId, '#' + tableId, function () {
                //                 layer.closeAll();
                //                 table.ajax.reload();
                //             })
                //         });
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/partner/umbrella/pagination?" + arr).load();
        })

        $(".table-reset").on('click', function () {
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/partner/umbrella/pagination").load();
        })
