...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/partner/message/pagination',
            columns: [
                {
                    'data': 'id',
                ...
                //         <li>
                //             <a href="/partner/message/edit/` + data + `"> 编辑 <i class="fa fa-fw fa-pencil"></i> </a>
                //         </li>
                //         <li>
                //             <a class="csx-delete" data-url="/partner/message/delete/` + data + `" href="javascript:;"> 删除 <i class="fa fa-fw fa-trash"></i> </a>
                //         </li>
                //         <li>
                //             <a href="/partner/message/show/` + data + `"> 详情 <i class="fa fa-file-o"></i> </a>
                //         </li>
                //     </ul>
                // </div>`;
                //     }
            ...
            buttons: [
                {
                    ...
                    window.location.href = "/partner/message/create"
                }
                },
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/partner/message/pagination?" + arr).load();
        })

        $(".table-reset").on('click', function () {
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/partner/message/pagination").load();
        })
    ...
    exports.roll = function ($) {
        $.get('/partner/message/get-tops', {read: 0}, function (result) {
