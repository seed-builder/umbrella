...
define(function (require, exports, module) {
    ...
    exports.index = function ($, tableId, alertId) {
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/partner/customer-hire/pagination',
            columns: [
                {
                    'data': 'id',
            ...
            buttons: [
                ...
                //     window.location.href = "/partner/customer-hire/create"
                // }
                // },
                ...
                //{extend: 'print', text: '打印<i class="fa fa-fw fa-print"></i>'},
                {
                    ...
                    className: 'btn',
                    action: function () {
                        $(".search-form").attr('action', '/partner/customer-hire/export-excel')
                        $(".search-form").submit();
        ...
        $(".table-search").on('click', function () {
            ...
            var arr = $.param(data)
            table.ajax.url("/partner/customer-hire/pagination?" + arr).load();
        })

        $(".table-reset").on('click', function () {
            $(this).parents('.search-form')[0].reset();
            table.ajax.url("/partner/customer-hire/pagination").load();
        })
