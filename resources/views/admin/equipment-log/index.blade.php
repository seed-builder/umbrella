            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">equipment_logs搜索</span>
                    </div>
                    <div class="tools">
                    ...
                    <form class="form-horizontal search-form">
                        <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">api_name</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control filter-condition" name="filter[][api_name]" filter-op='like' filter-name='api_name'>
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control filter-condition" name="filter[][code]" filter-op='like' filter-name='code'>
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject bold uppercase font-dark">equipment_logs</span>
                    </div>
                    <div class="tools">
                        <a href="" class="collapse"> </a>
                    </div>
