...
<div class="page-content">
    <div class="page-head">
        <div class="page-title">
            <h1>top module
                <small>customer_account_records详情</small>
            </h1>
        </div>
    </div>
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span id="breadcrumb" class="active">customer_account_records详情</span>
        </li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">customer_account_records详情</span>
                    </div>
                    <div class="tools">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">customer_account_id:</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static"> {{$entity->customer_account_id}} </p>
                                            </div>
                                        </div>
                                    </div>
