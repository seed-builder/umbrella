...
<div class="page-content">
    <div class="page-head">
        <div class="page-title">
            <h1>top module
                <small>customer_account_records编辑</small>
            </h1>
        </div>
    </div>
            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">customer_account_records编辑</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    <form class="form-horizontal" id="form-id" action="/admin/customeraccountrecord/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="customer_account_id" value="{{$entity->customer_account_id}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
