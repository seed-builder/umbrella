            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">sys_logs编辑</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    <form class="form-horizontal" id="form-id" action="/admin/syslog/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                                        <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">action</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="action" value="{{$entity->action}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="module" value="{{$entity->module}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
