...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span id="breadcrumb" class="active">sys_logs详情</span>
        </li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">sys_logs详情</span>
                    </div>
                    <div class="tools">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static"> {{$entity->action}} </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static"> {{$entity->module}} </p>
                                            </div>
                                        </div>
                                    </div>
