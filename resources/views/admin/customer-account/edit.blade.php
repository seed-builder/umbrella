...
<div class="page-content">
    <div class="page-head">
        <div class="page-title">
            <h1>top module
                <small>customer_accounts编辑</small>
            </h1>
        </div>
    </div>
            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">customer_accounts编辑</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    <form class="form-horizontal" id="form-id" action="/admin/customeraccount/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                                        <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">balance_amt</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="balance_amt" value="{{$entity->balance_amt}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="freeze_amt" value="{{$entity->freeze_amt}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
