                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="postal_code" id="code"
                                                   readonly>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script type="text/javascript"
            src='http://webapi.amap.com/maps?v=1.3&key=3e3dbb3d6dce66cd3b9fd70e234bb050&plugin=AMap.Autocomplete,AMap.Geocoder'></script>
    <script type="text/javascript">
