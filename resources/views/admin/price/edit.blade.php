                    ...
                    <form class="form-horizontal" id="form-id" action="/admin/price/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="hire_day_cash" value="{{$entity->hire_day_cash}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="hire_expire_days" value="{{$entity->hire_expire_days}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="hire_free_days" value="{{$entity->hire_free_days}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
