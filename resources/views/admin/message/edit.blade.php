            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">messages编辑</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    <form class="form-horizontal" id="form-id" action="/admin/message/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="channel" value="{{$entity->channel}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="read" value="{{$entity->read}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
