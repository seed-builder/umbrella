                    ...
                    <form class="form-horizontal search-form">
                        <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control filter-condition" name="filter[][engineer]" filter-op='like' filter-name='engineer'>
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control filter-condition" name="filter[][maintain_content]" filter-op='like' filter-name='maintain_content'>
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
