                ...
                <div class="portlet light bordered" id="blockui-id">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">设备维护记录编辑</span>
                        </div>

                    </div>
                    <div class="portlet-body form">
                        <form class="form-horizontal" id="form-id"
                              action="/admin/equipmentmaintain/edit/{{$entity->id}}">
                            {{ csrf_field() }}
                            <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="equipment_id">
                                                @foreach($equipments as $equipment)
                                                    <option value="{{$equipment->id}}" {{$equipment->id==$entity->equipment_id ? 'selected' : ''}}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">维护记录内容</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="maintain_content"
                                                   value="{{$entity->maintain_content}}">
                                        </div>
                                    </div>
                                </div>
