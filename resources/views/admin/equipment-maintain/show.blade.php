...
<div class="page-content">
    <div class="page-head">
        <div class="page-title">
            <h1>top module
                <small>equipment_maintains详情</small>
            </h1>
        </div>
    </div>
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span id="breadcrumb" class="active">equipment_maintains详情</span>
        </li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">equipment_maintains详情</span>
                    </div>
                    <div class="tools">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">engineer:</label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">maintain_content:</label>
                                            <div class="col-md-9">
