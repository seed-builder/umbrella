                            ...
                            <div class="form-body">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="filter[][partner_id]">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">是否过滤无经销商的数据</label>
                                        <div class="col-md-9">
                                            <select class="form-control" name="filter[][filter_no_partner]">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            seajs.use('admin/view_partner_statistics.js', function (app) {
