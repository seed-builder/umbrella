...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span id="breadcrumb"  class="active">equipments</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">equipments搜索</span>
                    </div>
                    <div class="tools">
                    ...
                    <form class="form-horizontal search-form">
                        <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="filter[][capacity]">
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="filter[][have]">
                                        </div>
                                    </div>
                                </div>
                                                            <div class="col-md-4">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject bold uppercase font-dark">equipments</span>
                    </div>
                    <div class="tools">
                        <a href="" class="collapse"> </a>
                    </div>
