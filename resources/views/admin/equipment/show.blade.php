...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span id="breadcrumb" class="active">equipments详情</span>
        </li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-haze bold uppercase">equipments详情</span>
                    </div>
                    <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <p class="form-control-static"> {{$entity->deleted_at}} </p>
                                                                    ...
                                                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">have:</label>
                                            <div class="col-md-9">
