            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">equipments编辑</span>
                    </div>
                    ...
                    <form class="form-horizontal" id="form-id" action="/admin/equipment/edit/{{$entity->id}}">
                        {{ csrf_field() }}                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="capacity" value="{{$entity->capacity}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="have" value="{{$entity->have}}">
                                    </div>
                                </div>
                            </div>
                                                        <div class="col-md-6">
