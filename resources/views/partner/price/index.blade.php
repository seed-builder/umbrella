                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">押金规则搜索</span>
                        </div>
                        <div class="tools">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase font-dark">押金规则</span>
                        </div>
                        <div class="tools">
                            <a href="" class="collapse"> </a>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            seajs.use('partner/price.js', function (app) {
