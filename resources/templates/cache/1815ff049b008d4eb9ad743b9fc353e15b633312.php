    ...
    <div class="page-head">
        <div class="page-title">
            <h1><?php echo e(isset($topModule) ? $topModule : 'top module'); ?>
                ...
                <small><?php echo e($table); ?>编辑</small>
            </h1>
        </div>
    </div>
            ...
            <div class="portlet light bordered" id="blockui-id">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"><?php echo e($table); ?>编辑</span>
                    </div>

                </div>
                <div class="portlet-body form">
                    <form class="form-horizontal" id="form-id" action="<?php echo '/admin/'.snake_case($model,'').'/edit/{{$entity->id}}' ?>">
                        <?php echo '{{ csrf_field() }}'?>
                        <div class="form-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="<?php echo e($col->name); ?>" value="<?php echo '{{$entity->'.$col->name.'}}'  ; ?>">
                                    </div>
                                </div>
                            </div>
