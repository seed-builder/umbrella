    ...
    <div class="pull-to-refresh-content" :id="options.refreshId" data-ptr-distance="20">
        <div class="content infinite-scroll infinite-scroll-bottom"
            ...
            <div class="card-container">
                <div class="card"
                     :class="{'ajax-link':options.itemUrl} "
                ...
                >
                    ...
                    <div class="card-content" @click="options.itemBtns?showBtns(item):''">
                        <div class="row">
                            <div class="col-50">
                                <div class="card-content-inner card-content-item item-left" v-html="options.left(item)"></div>
                            </div>
                            <div class="col-50">
                                <div class="card-content-inner card-content-item item-right" v-html="options.right(item)"></div>
                            </div>
                        </div>
                    </div>
        ...
        methods: {
            ...
            initSearch: function () {
                ...
                $(document).on('click','#'+self.options.searchBtnId,function () {
                    self.options.ajax = '/mobile/customer-payment/pagination?'+$('#'+self.options.searchFormId).serialize();
                    self.reload();
                })
            }
        }
