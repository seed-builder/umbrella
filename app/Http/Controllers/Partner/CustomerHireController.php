...
class CustomerHireController extends BaseController
{
	...
	*/
	...
	{
		//
		return view('partner.customer-hire.index');
	}
	...
	*/
	...
	{
		$entity = CustomerHire::find($id);
		return view('partner.customer-hire.show', ['entity' => $entity]);
	}
	...
	*/
	public function pagination(Request $request, $searchCols = [], $with=[], $conditionCall = null, $dataHandleCall = null, $all_columns = false){
		...
		return parent::pagination($request,$searchCols,$with,function($queryBuilder){
			...
			$queryBuilder->whereIn('hire_equipment_id',$equipment_ids);
		},function ($entities) {
    ...
    {
        parent::exportExcel($request, $searchCols, $with, function($queryBuilder){
            $partner = Auth::guard('partner')->user();
            $equipment_ids = $partner->equipments->pluck('id')->toArray();
